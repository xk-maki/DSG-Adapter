...
For the other two variants, modify the corresponding configuration file and working directory:

```bash
# DSG-Adapter‡
python tools/train.py DSG_Adapter_configs/torchsig_base_22k_3x/torchsig_retinanet_swin_base_3x_full_rgb_imagenet_DSG-Adapter_mlp.py \
    --work-dir exp_DSG-Adapter_mlp


# DSG-Adapter*
python tools/train.py DSG_Adapter_configs/torchsig_base_22k_3x/torchsig_retinanet_swin_base_3x_full_rgb_imagenet_DSG-Adapter.py \
