...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.,tuning_mode=None):
...
class SwinTransformer_ssf(nn.Module):
    ...
    def init_weights(self, pretrained=None):
        ...
        for name, param in self.named_parameters():
            ...
            if 'ssf_scale' in name or 'ssf_shift' in name or 'patch_embed' in name:
    ...
    def train(self, mode=True):
        ...
        super(SwinTransformer_ssf, self).train(mode)
        print('=================================train=====================================')
        self._freeze_stages()
